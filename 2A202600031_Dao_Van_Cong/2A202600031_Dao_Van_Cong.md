...
- **Báo cáo Billing:** Hệ thống GCP Billing có độ trễ cập nhật (như thông báo của Google). Em đã kiểm tra và chụp lại dashboard tại thời điểm hoàn thành. Ngoài ra có thêm ảnh minh chứng VM Instance vẫn chạy. **ĐẾN Day 17 tức 24/4/2026: Đã có Bill**

![Báo cáo Billing](evidence/bill.png)

![Ảnh minh chứng vẫn chạy](evidence/vm_instance.png)

![Ngày Day 17 chụp lại có Bill](evidence/real_bill.png)
